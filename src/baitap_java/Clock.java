...
public class Clock extends JFrame {
    ...
    private Timer timer;
    private int sub = 0; 
    private JTextField txClock;

    public Clock() {
        Container con = getContentPane();
        getContentPane().setLayout(null);
        JLabel lbbackground = new JLabel();
        lbbackground.setBackground(new Color(200, 200, 200));
        ...
        lblNewLabel.setForeground(new Color(15, 22, 0));
        lblNewLabel.setBackground(new Color(25, 25, 20));
        ...
        lblNewLabel_1.setForeground(new Color(150, 0, 0));
